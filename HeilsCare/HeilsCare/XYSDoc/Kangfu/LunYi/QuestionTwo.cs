...
namespace XYS.Remp.Screening.Kangfu.LunYi
{
    public partial class QuestionTwo : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            question1.QuestionCode = QuestionnaireCode.KangFuLunYi + ".2";
        ...
        {
            string answer = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuLunYi, QuestionnaireCode.KangFuLunYi + ".2");
