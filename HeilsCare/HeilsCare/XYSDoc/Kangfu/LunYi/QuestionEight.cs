...
namespace XYS.Remp.Screening.Kangfu.LunYi
{
    public partial class QuestionEight : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            question1.QuestionCode = QuestionnaireCode.KangFuLunYi + ".8";
        ...
        {
            string answer = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuLunYi, QuestionnaireCode.KangFuLunYi + ".8");
