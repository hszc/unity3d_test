...
namespace XYS.Remp.Screening.Kangfu.LunYi
{
    public partial class QuestionTen : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            question1.QuestionCode = QuestionnaireCode.KangFuLunYi + ".10";
        ...
        {
            string answer = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuLunYi, QuestionnaireCode.KangFuLunYi + ".10");
