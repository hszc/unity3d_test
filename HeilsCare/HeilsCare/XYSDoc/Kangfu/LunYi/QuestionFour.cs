...
namespace XYS.Remp.Screening.Kangfu.LunYi
{
    public partial class QuestionFour : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            question1.QuestionCode = QuestionnaireCode.KangFuLunYi + ".4";
        ...
        {
            string answer = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuLunYi, QuestionnaireCode.KangFuLunYi + ".4");
