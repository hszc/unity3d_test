...
namespace XYS.Remp.Screening.Kangfu.JiZhu
{
    public partial class QuestionThree : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            AddResult(question1, QuestionnaireCode.KangFuJiZhu + ".2.B.1");
            ...
            AddResult(question2, QuestionnaireCode.KangFuJiZhu + ".2.B.2");
            ...
            AddResult(question3, QuestionnaireCode.KangFuJiZhu + ".2.B.3");
            ...
            AddResult(question4, QuestionnaireCode.KangFuJiZhu + ".2.B.4");
        ...
        {
            string answer1 = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuJiZhu, QuestionnaireCode.KangFuJiZhu + ".2.B.1");
            string answer2 = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuJiZhu, QuestionnaireCode.KangFuJiZhu + ".2.B.2");
            string answer3 = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuJiZhu, QuestionnaireCode.KangFuJiZhu + ".2.B.3");
            string answer4 = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuJiZhu, QuestionnaireCode.KangFuJiZhu + ".2.B.4");
