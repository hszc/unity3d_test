...
namespace XYS.Remp.Screening.Kangfu.JiZhu
{
    public partial class QuestionFour : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            AddResult(question1, QuestionnaireCode.KangFuJiZhu + ".3.A.1");
            ...
            AddResult(question2, QuestionnaireCode.KangFuJiZhu + ".3.A.2");
            ...
            AddResult(question3, QuestionnaireCode.KangFuJiZhu + ".3.A.3");
            ...
            AddResult(question4, QuestionnaireCode.KangFuJiZhu + ".3.A.4");
        ...
        {
            string answer1 = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuJiZhu, QuestionnaireCode.KangFuJiZhu + ".3.A.1");
            string answer2 = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuJiZhu, QuestionnaireCode.KangFuJiZhu + ".3.A.2");
            string answer3 = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuJiZhu, QuestionnaireCode.KangFuJiZhu + ".3.A.3");
            string answer4 = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuJiZhu, QuestionnaireCode.KangFuJiZhu + ".3.A.4");
