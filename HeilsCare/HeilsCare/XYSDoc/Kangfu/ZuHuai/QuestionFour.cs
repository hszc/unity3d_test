...
namespace XYS.Remp.Screening.Kangfu.ZuHuai
{
    public partial class QuestionFour : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            question.QuestionCode = Public.QuestionnaireCode.KangFuZuHuai + ".4";
        ...
        {
            string answer = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuZuHuai, QuestionnaireCode.KangFuZuHuai + ".4");
