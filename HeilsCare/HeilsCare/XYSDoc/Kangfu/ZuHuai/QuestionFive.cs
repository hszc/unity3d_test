...
namespace XYS.Remp.Screening.Kangfu.ZuHuai
{
    public partial class QuestionFive : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            question.QuestionCode = Public.QuestionnaireCode.KangFuZuHuai + ".5";
        ...
        {
            string answer = ClientInfo.GetAnswerByCode(QuestionnaireCode.KangFuZuHuai, QuestionnaireCode.KangFuZuHuai + ".5");
