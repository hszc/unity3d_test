...
namespace XYS.Remp.Screening.Naocuzhong
{
    public partial class QuestionTwo : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            AddResult(question1, QuestionnaireCode.NaoCuZhong + ".2", 1);
            ...
            AddResult(question2, QuestionnaireCode.NaoCuZhong + ".2.1", 3);
            ...
            if (chkC.Checked)
                question3.QuestionResult += "C,";

            AddResult(question3, QuestionnaireCode.NaoCuZhong + ".2.2", 1);
            ...
            AddResult(question4, QuestionnaireCode.NaoCuZhong + ".2.3", 3);

            M_QuestionnaireResultDetail question5 = new M_QuestionnaireResultDetail();
            question5.QuestionResult = txt24.Text;
            AddResult(question5, QuestionnaireCode.NaoCuZhong + ".2.4", 3);

            M_QuestionnaireResultDetail question6 = new M_QuestionnaireResultDetail();
            question6.QuestionResult = txt25.Text;
            AddResult(question6, QuestionnaireCode.NaoCuZhong + ".2.5", 3);

            M_QuestionnaireResultDetail question7 = new M_QuestionnaireResultDetail();
            question7.QuestionResult = txt26.Text;
            AddResult(question7, QuestionnaireCode.NaoCuZhong + ".2.6", 3);

            M_QuestionnaireResultDetail question8 = new M_QuestionnaireResultDetail();
            question8.QuestionResult = txt27.Text;
            AddResult(question8, QuestionnaireCode.NaoCuZhong + ".2.7", 3);
        ...
        private void QuestionTwo_Load(object sender, EventArgs e)
        {
            ...
            BindMonth();
            BindDay();
            string answer1 = ClientInfo.GetAnswerByCode(QuestionnaireCode.NaoCuZhong, QuestionnaireCode.NaoCuZhong + ".2");
            string answer2 = ClientInfo.GetAnswerByCode(QuestionnaireCode.NaoCuZhong, QuestionnaireCode.NaoCuZhong + ".2.1");
            string answer3 = ClientInfo.GetAnswerByCode(QuestionnaireCode.NaoCuZhong, QuestionnaireCode.NaoCuZhong + ".2.2");
            string answer4 = ClientInfo.GetAnswerByCode(QuestionnaireCode.NaoCuZhong, QuestionnaireCode.NaoCuZhong + ".2.3");
            string answer5 = ClientInfo.GetAnswerByCode(QuestionnaireCode.NaoCuZhong, QuestionnaireCode.NaoCuZhong + ".2.4");
            string answer6 = ClientInfo.GetAnswerByCode(QuestionnaireCode.NaoCuZhong, QuestionnaireCode.NaoCuZhong + ".2.5");
            string answer7 = ClientInfo.GetAnswerByCode(QuestionnaireCode.NaoCuZhong, QuestionnaireCode.NaoCuZhong + ".2.6");
            string answer8 = ClientInfo.GetAnswerByCode(QuestionnaireCode.NaoCuZhong, QuestionnaireCode.NaoCuZhong + ".2.7");
            ...
            //if (dateConfirm > DateTime.MinValue) dtpConfirm.Value = dateConfirm;
            ...
            if (answer3.Contains("C")) chkC.Checked = true;

            if (answer4.Contains("A")) rd2A.Checked = true;
            if (answer4.Contains("B")) rd2B.Checked = true;
