...
namespace XYS.Remp.Screening.Zaoai.Dachang
{
    public partial class QuestionA1 :BaseForm
    {
        ...
        {
            string questionResultA = this.radCheckA03A.Checked ? "A" : radCheckA03B.Checked?"B":"";
            M_QuestionnaireResultDetail questionA = new M_QuestionnaireResultDetail();
                questionA.QuestionCode = Public.QuestionnaireCode.ZaoAiDaChangAi + ".A03";
                ...
                questionB.QuestionCode = Public.QuestionnaireCode.ZaoAiDaChangAi + ".A09";
            ...
            if (radCheckA09A.Checked)
            {
                ...
                question.QuestionCode = Public.QuestionnaireCode.ZaoAiDaChangAi + ".A09.1";
            ...
            //DaChangResult result = new DaChangResult();
            //result.ShowDialog();
            this.Close();
        }
        ...
        private void QuestionA1_Load(object sender, EventArgs e)
        {
            ...
            M_QuestionnaireUserDetail questionnaire = ClientInfo.GetQuestionnaireByCode(QuestionnaireCode.ZaoAiDaChangAi);

            if (questionnaire == null) return;

            IList<M_QuestionnaireResultDetail> questions = questionnaire.Questions;
            string answerA03 = ClientInfo.GetAnswerByCode(QuestionnaireCode.ZaoAiDaChangAi, QuestionnaireCode.ZaoAiDaChangAi + ".A03");
            ...
            if (a09.Count > 0)
            {
                ...
                {
                    if (item.QuestionCode == QuestionnaireCode.ZaoAiDaChangAi + ".A09")
                    {
                    ...
                    if (item.QuestionCode == QuestionnaireCode.ZaoAiDaChangAi + ".A09.1")
                    {
