...
{
    public partial class OabOne : BaseForm
    {
        public OabOne()
        {
            InitializeComponent();
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            question3.QuestionCode = QuestionnaireCode.Oab + ".3";
            question3.PQuestionCode = QuestionnaireCode.Oab + ".3";
            question3.QuestionType = 1;
            question3.QuestionScore = 0;
            question3.PQuestionWeightScore = 0;

            ClientInfo.AddQuestionToQuestionnaire(question3, QuestionnaireCode.Oab);
            ...
            question4.QuestionCode = QuestionnaireCode.Oab + ".4";
            question4.PQuestionCode = QuestionnaireCode.Oab + ".4";
            question4.QuestionType = 1;
            question4.QuestionScore = 0;
            question4.PQuestionWeightScore = 0;

            ClientInfo.AddQuestionToQuestionnaire(question4, QuestionnaireCode.Oab);
        ...
        private void OabOne_Load(object sender, EventArgs e)
        {
            string answer3= ClientInfo.GetAnswerByCode(QuestionnaireCode.Oab, QuestionnaireCode.Oab + ".3");
            if (answer3.Contains("A")) { rbQ3A.Checked = true; }
            if (answer3.Contains("B")) { rbQ3B.Checked = true; }

            string answer4 = ClientInfo.GetAnswerByCode(QuestionnaireCode.Oab, QuestionnaireCode.Oab + ".4");
