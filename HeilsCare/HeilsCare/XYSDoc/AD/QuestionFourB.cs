...
{
    public partial class QuestionFourB : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            question1.QuestionCode = QuestionnaireCode.NaoNianChiDai + ".4.B";
            ...
            QuestionFourC formC = new QuestionFourC();
            formC.TopMost = false;
            //formC.Show();
            formC.Show();
            this.Close();
        ...
        private void QuestionFourB_Load(object sender, EventArgs e)
        {
            string answer1 = ClientInfo.GetAnswerByCode(QuestionnaireCode.NaoNianChiDai, QuestionnaireCode.NaoNianChiDai + ".4.B");
        ...
        private void btnPlay_Click(object sender, EventArgs e)
        {
            ...
            wmPlayerForm.Play(@"Resources\Sound\AD\ad_4_2.m4a");
        }

        private void QuestionFourB_FormClosing(object sender, FormClosingEventArgs e)
        {
            //停止播放
            if (wmPlayerForm != null)
            {
